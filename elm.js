...
Elm.Click = Elm.Click || {};
Elm.Click.make = function (_elm) {
   "use strict";
   _elm.Click = _elm.Click || {};
   if (_elm.Click.values) return _elm.Click.values;
   var _U = Elm.Native.Utils.make(_elm),
   $Basics = Elm.Basics.make(_elm),
   $Debug = Elm.Debug.make(_elm),
   $Html = Elm.Html.make(_elm),
   ...
   $Signal = Elm.Signal.make(_elm);
   var _op = {};
   var textStyle = $Html$Attributes.style(_U.list([{ctor: "_Tuple2",_0: "font-size",_1: "20px"}
                                                  ,{ctor: "_Tuple2",_0: "font-family",_1: "fantasy"}
   ...
   var countStyle = $Html$Attributes.style(_U.list([{ctor: "_Tuple2",_0: "font-size",_1: "20px"}
                                                   ...
                                                   ,{ctor: "_Tuple2",_0: "text-align",_1: "center"}]));
   var update = F2(function (action,model) {    var _p0 = action;if (_p0.ctor === "Increment") {    return model + 1;} else {    return 0;}});
   var Reset = {ctor: "Reset"};
   var Increment = {ctor: "Increment"};
   var view = F2(function (address,model) {
      var count = A2($Debug.watch,"Contagem",model);
      return A2($Html.div,
      _U.list([]),
      _U.list([A2($Html.div,_U.list([textStyle]),_U.list([$Html.text("Clique no numero para incrementar: ")]))
              ,A2($Html.div,_U.list([countStyle,A2($Html$Events.onClick,address,Increment)]),_U.list([$Html.text($Basics.toString(count))]))
              ,A2($Html.button,_U.list([A2($Html$Events.onClick,address,Reset)]),_U.list([$Html.text("Colocar a 0")]))]));
   });
   return _elm.Click.values = {_op: _op,Increment: Increment,Reset: Reset,update: update,view: view,countStyle: countStyle,textStyle: textStyle};
};
Elm.Main = Elm.Main || {};
Elm.Main.make = function (_elm) {
   ...
   var _op = {};
   var main = $StartApp$Simple.start({model: 100,update: $Click.update,view: $Click.view});
